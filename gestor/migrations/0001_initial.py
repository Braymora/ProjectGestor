# Generated by Django 5.0 on 2024-03-07 10:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('probavilidad', models.IntegerField(choices=[(1, 'Muy Bajo'), (2, 'Bajo'), (3, 'Medio'), (4, 'Alto'), (5, 'Muy Alto')])),
                ('gravedad', models.IntegerField(choices=[(1, 'Muy Bajo'), (2, 'Bajo'), (3, 'Medio'), (4, 'Alto'), (5, 'Muy Alto')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proyect', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='tablero', to='gestor.proyecto')),
            ],
        ),
        migrations.CreateModel(
            name='Columna',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('titulo', models.CharField(max_length=200)),
                ('tablero', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='columnas', to='gestor.tablero')),
            ],
        ),
        migrations.CreateModel(
            name='Tarjeta',
            fields=[
                ...
                ('descripcion_markup_type', models.CharField(choices=[('', '--'), ('html', 'HTML'), ('plain', 'Plain'), ('markdown', 'Markdown')], default='markdown', editable=False, max_length=30)),
        ...
        migrations.AddField(
            model_name='hito',
            name='asignado',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='gestor.usuario'),
        ),
    ]
